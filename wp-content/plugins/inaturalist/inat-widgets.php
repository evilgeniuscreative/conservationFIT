...
class iNatLogin_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        ...
        parent::__construct(
            ...
            array('description' => __('iNaturalist plugin lateral block for user authentication (or creation)', 'text_domain'),) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        echo $args['before_widget']; // don't touch
        if (!empty($title))
...
function register_inat_widget()
{
    register_widget('iNatLogin_Widget');
}

add_action('widgets_init', 'register_inat_widget');
?>
